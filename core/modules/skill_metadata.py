SOFT_SKILLS = {
    ...
    "time management", "mentoring", "agile", "scrum", "sdlc", 
    "collaboration", "management", "critical thinking", "adaptability",
    "conflict resolution", "creativity", "stakeholder management",
...
SKILL_METADATA = {
    ...
    "python": {
        "learning_paths": [
            {"title": "Python for Everybody (edX)", "url": "https://www.edx.org/course/programming-for-everybody-getting-started-with-p"},
    ...
    "java": {
        "learning_paths": [
            {"title": "Java Programming Basics (Coursera)", "url": "https://www.coursera.org/learn/java-programming"},
            {"title": "Java Tutorial for Complete Beginners", "url": "https://www.udemy.com/course/java-tutorial/"}
        ],
    ...
    "c++": {
        "learning_paths": [
            {"title": "Learn C++ (Codecademy)", "url": "https://www.codecademy.com/learn/learn-c-plus-plus"},
    ...
    "react": {
        "learning_paths": [
            {"title": "React Official Tutorial", "url": "https://react.dev/learn/tutorial-tic-tac-toe"},
            {"title": "React Course - Beginner's Tutorial", "url": "https://www.freecodecamp.org/news/react-course-for-beginners/"}
        ],
    ...
    "angular": {
        "learning_paths": [
            {"title": "Tour of Heroes App and Tutorial", "url": "https://angular.io/tutorial"},
    ...
    "vue": {
        "learning_paths": [
            {"title": "Vue.js Official Guide", "url": "https://vuejs.org/guide/introduction.html"},
            {"title": "Intro to Vue 3 (VueMastery)", "url": "https://www.vuemastery.com/courses/intro-to-vue-3/intro-to-vue3"}
        ],
    ...
    "next.js": {
        "learning_paths": [
            ...
            {"title": "Next.js Full Course (FreeCodeCamp)", "url": "https://www.youtube.com/watch?v=vwSlYG7hFk0"}
        ],
    ...
    "node.js": {
        "learning_paths": [
            ...
            {"title": "The Net Ninja: Node.js Tutorial", "url": "https://www.youtube.com/playlist?list=PL4cUxeGkcC9jsz4LDYc6kv3ymONOKxwBU"}
        ],
    ...
    "django": {
        "learning_paths": [
            {"title": "Writing your first Django app", "url": "https://docs.djangoproject.com/en/stable/intro/tutorial01/"},
    ...
    "flask": {
        "learning_paths": [
            ...
            {"title": "Flask Documentation Quickstart", "url": "https://flask.palletsprojects.com/en/2.3.x/quickstart/"}
        ],
    ...
    "fastapi": {
        "learning_paths": [
            ...
            {"title": "FastAPI Course (FreeCodeCamp)", "url": "https://www.youtube.com/watch?v=tLKKmouUams"}
        ],
    ...
    "docker": {
         "learning_paths": [
            {"title": "Docker 101 Tutorial", "url": "https://www.docker.com/101-tutorial/"},
            {"title": "Docker Crash Course for Absolute Beginners", "url": "https://www.youtube.com/watch?v=pg19Z8LL06w"}
        ],
    ...
    "kubernetes": {
        "learning_paths": [
            ...
            {"title": "Kubernetes Crash Course for Absolute Beginners", "url": "https://www.youtube.com/watch?v=s_o8dwzRlu4"}
        ],
    ...
    "azure": {
        "learning_paths": [
            {"title": "Microsoft Learn: Azure Fundamentals", "url": "https://learn.microsoft.com/en-us/training/paths/az-900-describe-cloud-concepts/"},
            {"title": "Azure Full Course (FreeCodeCamp)", "url": "https://www.youtube.com/watch?v=NKEFWyqJ5XA"}
        ],
    ...
    "git": {
        "learning_paths": [
            {"title": "Git and GitHub for Beginners", "url": "https://www.freecodecamp.org/news/introduction-to-git-and-github/"},
    ...
    "sql": {
        "learning_paths": [
            {"title": "Intro to SQL: Querying and managing data", "url": "https://www.khanacademy.org/computing/computer-programming/sql"},
    ...
    "postgresql": {
        "learning_paths": [
            ...
            {"title": "🐘 Full PostgreSQL Course", "url": "https://www.youtube.com/watch?v=qw--VYLpxG4"}
        ],
    ...
    "mongodb": {
        "learning_paths": [
            ...
            {"title": "MongoDB Crash Course", "url": "https://www.youtube.com/watch?v=pWbMrx5rVBE"}
        ],
    ...
    "redis": {
         "learning_paths": [
            ...
            {"title": "Redis Crash Course", "url": "https://www.youtube.com/watch?v=jgpVdJB2sKQ"}
        ],
    ...
    "pandas": {
        "learning_paths": [
            ...
            {"title": "Pandas in 10 Minutes (Docs)", "url": "https://pandas.pydata.org/docs/user_guide/10min.html"}
        ],
    ...
    "numpy": {
        "learning_paths": [
            ...
            {"title": "Learn NumPy in 1 Hour", "url": "https://www.youtube.com/watch?v=QUT1VHiLmmI"}
        ],
    ...
    "tensorflow": {
        "learning_paths": [
            {"title": "TensorFlow Core Basics", "url": "https://www.tensorflow.org/tutorials/quickstart/beginner"},
            {"title": "Deep Learning with TensorFlow (Coursera)", "url": "https://www.coursera.org/specializations/deep-learning"}
        ],
    ...
    "pytorch": {
         "learning_paths": [
            ...
            {"title": "PyTorch for Deep Learning Full Course", "url": "https://www.youtube.com/watch?v=V_xro1bcAuA"}
        ],
    ...
    "scikit-learn": {
         "learning_paths": [
            ...
            {"title": "Machine Learning in Python with Scikit-Learn", "url": "https://www.datacamp.com/tutorial/machine-learning-python"}
        ],
    ...
    "leadership": {
         "learning_paths": [
            {"title": "Inspired Leadership Specialization (Coursera)", "url": "https://www.coursera.org/specializations/inspired-leadership"},
            {"title": "Everyday Leadership", "url": "https://www.coursera.org/learn/everyday-leadership"}
        ],
    ...
    "communication": {
         "learning_paths": [
            {"title": "Improving Communication Skills (Coursera)", "url": "https://www.coursera.org/learn/wharton-communication-skills"},
            {"title": "Effective Communication", "url": "https://www.edx.org/course/effective-communication"}
        ],
    ...
    "agile": {
         "learning_paths": [
            {"title": "Agile Crash Course", "url": "https://www.udemy.com/course/agile-crash-course/"},
    ...
    "problem solving": {
         "learning_paths": [
            {"title": "Effective Problem-Solving and Decision-Making (Coursera)", "url": "https://www.coursera.org/learn/problem-solving"},
            {"title": "Algorithmic Problem Solving", "url": "https://leetcode.com/explore/"}
        ],
